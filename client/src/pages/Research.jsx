...
import { FiBookOpen, FiActivity, FiUsers, FiAward, FiExternalLink } from 'react-icons/fi';
      ...
      <section style={{ background: '#003580', padding: '3rem 2rem 2.5rem' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.65)', fontFamily: 'Inter, sans-serif', maxWidth: 560, lineHeight: 1.7 }}>
            {lang === 'kn' ? 'ದಂತ ವೈದ್ಯಕೀಯ ಕ್ಷೇತ್ರದಲ್ಲಿ ಹೊಸ ಆವಿಷ್ಕಾರಗಳು ಮತ್ತು ವೈಜ್ಞಾನಿಕ ಪ್ರಗತಿಗೆ ಬದ್ಧವಾಗಿರುವ ನಮ್ಮ ಸಂಶೋಧನಾ ಕೇಂದ್ರದ ಬಗ್ಗೆ ತಿಳಿಯಿರಿ.' : 'Advancing the frontiers of oral health through evidence-based research, clinical trials, and interdisciplinary collaboration at our state-of-the-art Research Centre.'}
          </p>
        </div>
      </section>
          ...
          <div className="vs-grid-4">
            {highlights.map((h, i) => (
              <motion.div key={i} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}>
                <div className="vs-card" style={{ padding: '2rem', textAlign: 'center', borderBottom: `4px solid ${h.color}` }}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="vs-grid-3">
            {[
              ...
              <div key={idx} className="vs-card" style={{ padding: '2rem' }}>
