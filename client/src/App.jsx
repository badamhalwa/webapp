...
// Student pages
import AcademicPortalLanding from './pages/student/AcademicPortalLanding';
...
import PatientDirectory from './pages/faculty/PatientDirectory';
import QueueManagement from './pages/faculty/QueueManagement';
        ...
        <Suspense fallback={<LoadingSpinner />}>
          <Routes>
            ...
            <Route path="/student/*" element={
              <StudentGuard>
                <Routes>
                  <Route index element={<AcademicPortalLanding />} />
